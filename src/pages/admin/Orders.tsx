...
export default function Orders() {
  ...
  const getStatusBadge = (status: string) => {
    const variants: Record<string, { variant: "default" | "secondary" | "destructive", className: string }> = {
      pending: { 
        variant: "secondary", 
        className: "bg-yellow-100 text-yellow-700 hover:bg-yellow-100 dark:bg-yellow-900/20 dark:text-yellow-500" 
      },
      completed: { 
        variant: "default", 
        className: "bg-green-100 text-green-700 hover:bg-green-100 dark:bg-green-900/20 dark:text-green-500" 
      },
      canceled: { 
        variant: "destructive", 
        className: "bg-red-100 text-red-700 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-500" 
      },
    };
